products = [
    ...
    },
    {
        ...
        'description': "Meet Echo Dot - Our most popular smart speaker with a fabric design. It is our most compact smart speaker that fits perfectly into a small space",
        'brand': "Amazon",
        'category': "Electronics",
        'price': 29.99,
        'countInStock': 0,
